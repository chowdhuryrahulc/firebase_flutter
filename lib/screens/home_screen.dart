...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void delete(String storagePath, String documentId)async{
    FirebaseStorage.instance.ref(storagePath).delete();
  ...
  void saveUser() async {
    ...
    if(name != "" && email != "" && profilepic != null) {
      ...
      // Upload to Firebase Storage (like S3)
      ...
      // get downloadUrl to upload to cloud firestore
            ...
            child: Column(
              children: [
                ...
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection("users").where("age", isGreaterThanOrEqualTo: 10).orderBy("age", descending: true).snapshots(),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                trailing: IconButton(
                                  onPressed: () {
                                    // Delete 
                                    delete(userMap["profilepic"], snapshot.data!.docs[index].id);
                                  },
